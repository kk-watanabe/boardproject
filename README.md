...
## 今後の展望
現在は就労移行支援事業所にて、Djangoを用いた図書館管理アプリの開発に取り組んでいます。基本のCRUD機能の実装に加え、貸出返却機能、予約機能、ユーザー操作を意識した画面設計、エラー発生時の処理、ヴァリデーションなど、実務を想定した開発を意識して取り組んでいきます。今後はさらにAPIを導入し、蔵書登録の自動効率化まで実装しようと考えています。
